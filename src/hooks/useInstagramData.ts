...
export function useInstagramData() {
  ...
  const [postPerformanceData, setPostPerformanceData] = useState<any[]>(
    mockInstagram.postPerformanceData
  );
      ...
      try {
        ...
        if (kpiRes.data) {
          ...
          setInstagramKpis({
            ...
            engagementRate: {
              value: k.engagement_rate,
              change: k.engagement_rate_change,
            ...
            profileVisits: {
              value: k.profile_visits,
              change: k.profile_visits_change,
        ...
        if (postsRes.data && postsRes.data.length > 0) {
          setPostPerformanceData(
            postsRes.data.map((r: any, i: number) => ({
              id: i + 1,
              type: r.post_type,
              gradient: r.gradient,
              caption: r.caption,
