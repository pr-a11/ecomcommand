export const kpiData = {
  grossSales: {
    ...
    label: 'Gross Sales',
    sparkline: [
      95000, 88000, 102000, 97000, 115000, 108000, 92000, 86000, 99000, 104000, 97000, 88000,
    ],
  },
  invoicedSales: {
    value: 632314,
    ...
    sparkline: [42000, 48000, 51000, 58000, 62000, 55000, 67000, 71000, 65000, 69000, 74000, 78000],
  },
  netSales: {
    value: 584721,
    change: 31.1,
    label: 'Net Sales',
    sparkline: [38000, 44000, 47000, 54000, 58000, 51000, 63000, 67000, 61000, 65000, 70000, 72000],
  },
  orders: {
    value: 144,
    change: -5.9,
...
export const topSkusData = [
  {
    rank: 1,
    sku: 'NKL-GLD-001',
    name: 'Kundan Layered Necklace Set',
    netSales: 124800,
    units: 18,
    orders: 14,
    category: 'Necklace',
  },
  {
    rank: 2,
    sku: 'CMB-WED-004',
    name: 'Bridal Combo — Necklace + Earrings',
    netSales: 98400,
    units: 12,
    orders: 10,
    category: 'Combo',
  },
  {
    rank: 3,
    sku: 'ERG-OXD-008',
    name: 'Oxidised Jhumka Earring Pair',
    netSales: 76200,
    units: 42,
    orders: 38,
    category: 'Earring',
