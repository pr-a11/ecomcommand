...
export const inventorySyncData = [
  { product: 'Kundan Layered Necklace Set', sku: 'NKL-GLD-001', shopify: 24, amazon: 18, flipkart: 12, myntra: 8, total: 62, status: 'In Stock' },
  { product: 'Bridal Combo Set', sku: 'CMB-WED-004', shopify: 8, amazon: 4, flipkart: 3, myntra: 2, total: 17, status: 'Low Stock' },
  { product: 'Oxidised Jhumka Earrings', sku: 'ERG-OXD-008', shopify: 84, amazon: 62, flipkart: 48, myntra: 36, total: 230, status: 'In Stock' },
  { product: 'Silver Toe Ring Set', sku: 'RNG-SLV-012', shopify: 42, amazon: 28, flipkart: 0, myntra: 14, total: 84, status: 'OOS on Flipkart' },
  { product: 'Choker Pearl Necklace', sku: 'NKL-CHK-016', shopify: 16, amazon: 12, flipkart: 8, myntra: 6, total: 42, status: 'In Stock' },
  { product: 'Glass Bangle Set', sku: 'BNG-GLS-021', shopify: 124, amazon: 84, flipkart: 62, myntra: 48, total: 318, status: 'In Stock' },
