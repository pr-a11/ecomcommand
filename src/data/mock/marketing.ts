export const marketingKpiData = {
  ...
  blendedROAS: { value: 13.7, change: 0, label: 'Blended ROAS', caption: 'Strong ROAS' },
  attributedSales: {
    value: 227682,
    change: 0,
...
export const campaignData = [
  ...
  },
  {
    id: 'camp-002',
    platform: 'meta',
    name: 'Retargeting — Recent Visitors',
    spend: 12400,
    attributedSales: 48200,
    orders: 6,
    roas: 3.89,
    status: 'Scale' as const,
  },
  ...
  },
  {
    id: 'camp-006',
    platform: 'meta',
    name: 'Retarget by Occasion — Wedding',
    spend: 6800,
    attributedSales: 21400,
    orders: 4,
    roas: 3.15,
    status: 'Scale' as const,
  },
  ...
  },
  {
    id: 'camp-008',
    platform: 'meta',
    name: 'Catalog / DPA — Retarget',
    spend: 8900,
    attributedSales: 12400,
    orders: 3,
    roas: 1.39,
    status: 'Hold' as const,
  },
  ...
  },
  {
    id: 'camp-010',
    platform: 'google',
    name: 'Search — Competitor Conquest',
    spend: 3004,
    attributedSales: 2671,
    orders: 1,
    roas: 0.89,
    status: 'Cut' as const,
  },
