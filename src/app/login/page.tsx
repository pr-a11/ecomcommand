        ...
        <div className="bg-card border border-border rounded-2xl shadow-card-hover p-6">
          ...
          {mode === 'login' && (
            <div className="mt-5 pt-5 border-t border-border">
              <p className="text-xs text-muted-foreground text-center mb-3 font-500">Demo Credentials</p>
              ...
              <p className="text-xs text-muted-foreground text-center mt-2">Password: dashboard123</p>
            </div>
          )}
        </div>

        <p className="text-center text-xs text-muted-foreground mt-4">
          support@chronicle.ai
        </p>
      </div>
    </div>
  );
