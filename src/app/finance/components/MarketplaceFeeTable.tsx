  ...
  return (
    <div className="chart-card">
      ...
      <p className="text-xs text-muted-foreground mb-4">
        Commission + closing + shipping fees eating into gross per channel
      </p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-right text-xs font-600 text-muted-foreground pb-2 pr-3">
                Referral %
              </th>
              <th className="text-right text-xs font-600 text-muted-foreground pb-2 pr-3">
                Closing %
                ...
                <td className="py-2.5 pr-4">
                  <div className="flex items-center gap-2">
                    <span
                      ...
                      style={{
                        backgroundColor:
                          marketplaceColors[row.marketplace] || 'var(--muted-foreground)',
                      }}
                    />
          ...
          <tfoot>
            <tr className="border-t-2 border-border bg-muted/30">
              <td className="py-2.5 pr-4 text-sm font-700 text-foreground" colSpan={5}>
                Total Fee Leakage
              </td>
