          ...
          <div className="flex gap-4 mt-2 mb-3">
            <div>
              <p className="text-xs text-gray-500">
                Share of sales:{' '}
                <span className="font-semibold text-gray-700">{COD_DATA?.shareOfSales}%</span>
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500">
                Share of orders:{' '}
                <span className="font-semibold text-gray-700">{COD_DATA?.shareOfOrders}%</span>
              </p>
            </div>
          </div>
          <div className="space-y-2 border-t border-gray-100 pt-3">
            <div className="flex justify-between text-xs">
              ...
              <span className="font-semibold text-gray-800">
                {formatINR(COD_DATA?.netSalesVal)}
              </span>
            </div>
            <div className="flex justify-between text-xs">
        ...
        <div className="border border-gray-200 bg-gray-50/40 rounded-lg p-4 relative">
          ...
          <div className="flex gap-4 mt-2 mb-3">
            <div>
              <p className="text-xs text-gray-500">
                Share of sales:{' '}
                <span className="font-semibold text-gray-800">{PREPAID_DATA?.shareOfSales}%</span>
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500">
                Share of orders:{' '}
                <span className="font-semibold text-gray-800">{PREPAID_DATA?.shareOfOrders}%</span>
              </p>
            </div>
          </div>
          <div className="space-y-2 border-t border-gray-200 pt-3">
            <div className="flex justify-between text-xs">
              <span className="text-gray-500">Net Sales</span>
              <span className="font-semibold text-gray-800">
                {formatINR(PREPAID_DATA?.netSalesVal)}
              </span>
            </div>
            <div className="flex justify-between text-xs">
              <span className="text-gray-500">– COGS</span>
