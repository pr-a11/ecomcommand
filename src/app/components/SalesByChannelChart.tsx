      ...
      <div className="flex flex-wrap items-center gap-1.5 mt-4 pt-3 border-t border-gray-100">
        <button
          ...
          className={`text-xs font-semibold px-2.5 py-1 rounded-full border transition-colors ${
            activeChannel === 'all' ?'bg-gray-900 text-white border-gray-900' :'bg-white text-gray-500 border-gray-200 hover:border-gray-300'
          }`}
        >
          All
        </button>
          ...
          <button
            ...
            style={
              activeChannel === ch.key
                ? { backgroundColor: ch.color + '18', color: ch.color, borderColor: ch.color + '50' }
