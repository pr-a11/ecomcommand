          ...
          return (
            ...
            >
              <div className="flex items-start gap-2.5">
                <div
                  className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 ${config.iconBg}`}
                >
                  <IconComp size={14} className={config.iconColor} />
                </div>
                <div className="min-w-0">
                  <p
                    className={`text-xs font-bold uppercase tracking-wider mb-1 ${config.labelColor}`}
                  >
