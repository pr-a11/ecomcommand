    ...
    <div className="chart-card h-full flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center flex-1 gap-4 py-4">
        <div className="text-center">
          <p className="text-xs font-600 uppercase tracking-wider text-muted-foreground mb-1">Abandoned Carts</p>
        ...
        <div className="text-center">
          <p className="text-xs font-600 uppercase tracking-wider text-muted-foreground mb-1">Recoverable Sales</p>
          <p className="text-2xl font-700 text-amber-600 tabular-nums">{formatINR(recoverableSales)}</p>
        </div>
