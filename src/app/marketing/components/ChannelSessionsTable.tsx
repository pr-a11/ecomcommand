...
export default function ChannelSessionsTable() {
  ...
  return (
    <div className="chart-card">
      ...
      <p className="text-xs text-muted-foreground mb-4">GA4 · Sessions, orders, sales, and conversion rate by traffic source</p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-right text-xs font-600 text-muted-foreground pb-2 pr-4">Sessions</th>
