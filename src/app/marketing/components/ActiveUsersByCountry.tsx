...
const LAND_PATHS = [
  ...
  {
    code: 'CA',
    d: 'M 68,42 L 88,38 L 120,35 L 155,32 L 185,30 L 215,28 L 240,30 L 258,35 L 268,42 L 272,50 L 265,58 L 248,62 L 228,65 L 205,68 L 182,70 L 158,72 L 135,70 L 112,65 L 92,60 L 75,52 Z M 52,55 L 68,50 L 72,62 L 58,68 L 45,62 Z M 30,48 L 52,44 L 55,55 L 38,60 L 25,55 Z',
  },
  // USA
  {
    code: 'US',
    d: 'M 72,72 L 265,65 L 272,75 L 270,90 L 262,102 L 245,112 L 222,118 L 195,122 L 165,124 L 138,122 L 112,116 L 90,108 L 76,96 Z M 42,108 L 72,102 L 76,115 L 62,122 L 45,118 Z',
  },
  // Mexico
  {
    code: 'MX',
    d: 'M 76,124 L 195,120 L 205,132 L 200,148 L 182,158 L 158,162 L 132,158 L 108,150 L 88,140 Z',
  },
  // Central America
  ...
  {
    code: 'BR',
    d: 'M 205,208 L 295,200 L 328,212 L 342,235 L 345,268 L 335,302 L 315,328 L 285,348 L 252,358 L 222,352 L 202,335 L 192,308 L 188,278 L 195,248 L 205,225 Z',
  },
  // Peru
  ...
  {
    code: 'AR',
    d: 'M 202,338 L 248,335 L 258,365 L 248,402 L 232,432 L 215,440 L 198,425 L 192,398 L 195,368 Z',
  },
  // Chile
  {
    code: 'CL',
    d: 'M 192,278 L 210,275 L 218,340 L 210,402 L 198,432 L 185,428 L 182,398 L 188,340 Z',
  },
  // UK
  ...
  {
    code: 'RU',
    d: 'M 508,42 L 620,32 L 720,28 L 800,32 L 840,42 L 845,58 L 820,72 L 775,80 L 720,85 L 660,88 L 600,88 L 548,85 L 515,78 L 505,62 Z',
  },
  // Turkey
  ...
  {
    code: 'IN',
    d: 'M 622,155 L 678,148 L 698,165 L 702,198 L 690,235 L 665,258 L 632,265 L 608,250 L 595,222 L 598,195 L 608,172 Z',
  },
  // Bangladesh
  ...
  {
    code: 'CN',
    d: 'M 658,100 L 775,90 L 800,108 L 805,145 L 785,168 L 742,182 L 698,178 L 662,162 L 645,142 L 648,120 Z',
  },
  // Japan
  ...
  {
    code: 'ID',
    d: 'M 712,258 L 768,250 L 782,262 L 772,278 L 722,282 L 708,268 Z M 778,258 L 812,252 L 818,268 L 802,278 L 775,275 Z',
  },
  // Malaysia
  ...
  {
    code: 'AU',
    d: 'M 718,305 L 808,298 L 848,315 L 858,352 L 842,388 L 802,405 L 755,408 L 715,392 L 695,362 L 698,330 Z',
  },
  // New Zealand
  {
    code: 'NZ',
    d: 'M 858,378 L 875,368 L 882,388 L 868,408 L 852,402 Z M 862,412 L 878,405 L 885,425 L 868,435 Z',
  },
  // Greenland
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-gray-50 rounded-lg overflow-hidden" style={{ height: '200px' }}>
          ...
          >
            ...
            <text x="756" y="448" fontSize="9" fill="#9ca3af" textAnchor="end">
              FEWER
            </text>
            <text x="895" y="448" fontSize="9" fill="#9ca3af" textAnchor="start">
              MORE
            </text>
          </svg>
        </div>
